<template>
    <div class="network-detail" v-loading="loading">
        ...
        <div class="cod" v-if="tableData.length>0">
            <div class="cod-title">网元适配信息</div>
            <el-table
                :data="tableData"
                size="small">
                ...
                <el-table-column align="center" prop="drivingState" label="指令驱动状态" width="100"></el-table-column>
                <el-table-column align="center" label="网元状态" width="100">
                    <template slot-scope="scope">
                        {{scope.row.status}}
                    </template>
                </el-table-column>
                <el-table-column align="center" label="详情" width="60">
                    <template slot-scope="scope">
                        <el-button
                        size="mini"
                        type="text"
...
export default {
    ...
    methods:{
        ...
        async getData(){
            ...
            if(res.networkDeviceList){
                res.networkDeviceList.forEach(item =>{
                ...
                this.tableData = res.networkDeviceList
            }
        },
        //详情
        details(item){
