  ...
  methods: {
    ...
    async getName() {
      let res = await this.$http.get(
        "/OpsDev/orderAnalysisOutputModel/getAnalysisModelListByName",
        {
          params: {
            name: this.name,
    ...
    handleSelect({ orderAnalysisOutputModelDetailsList, id }) {
      this.params = orderAnalysisOutputModelDetailsList.map(item => {
        return {
    ...
    del(id,i) {
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        ...
        .then(async () => {
          let res = await this.$http.get(
            "/OpsDev/orderAnalysisOutputModel/delOrderAnalysisOutputModel",
            {
              params: { id }
            }
          );
