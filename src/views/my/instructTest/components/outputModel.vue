...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async saveModel() {
        let res = await this.$http.post('/OpsDev/orderAnalysisOutputModel/addOrderAnalysisOutputModel', {
          modelName:this.outputData.modelName,
          orderAnalysisOutputModelDetailsList:this.params
        })
